...
2 drawbacks of AI are sometimes they give you codes that you don't necessarily needed or too complicated that fall out the range of your understanding / makes it more confuse, and sometimes AI cannot comprehend the mistake in the code because they don't directly "connect" to the program you are using and you must input the error message manually.

2 benefits of AI is they could code way faster than human (they don't need to "think") and in general they do tend to fix your error correcly, but you must input the correct and detailed prompt of what you want it to do.

10. Do you think you will use AI for coding in the future? Why or why not?

I think I will use it for coding but mainly on asking it to give me guidance / ask it to proofread my code because I won't fully trust AI on coding since someone the code require critical thinking.
