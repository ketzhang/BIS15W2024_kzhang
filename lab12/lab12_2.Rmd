...
fill wont work in scatter, must use color = xyz
```{r}
q <- homerange %>% 
...
```{r}
p+theme_linedraw()+
  theme(legend.position = "bottom", #you can change it to top, left, right
        axis.text.x = element_text(angle = 60, hjust=1))+
  labs(title = "Observations by Taxon in Homerange Data",
       x = NULL, #null will remove name of the x axis
       y= "n",
       fill= "Trophic Guild")
```
