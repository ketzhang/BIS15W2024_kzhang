...
```
## # A tibble: 1,344 × 2
##    asfis_species_name        mean_ca
##    <chr>                       <dbl>
##  1 Ablennes hians               18  
##  2 Abramis brama                 9.4
##  3 Abramis spp                   9  
##  4 Acanthistius brasilianus      5  
##  5 Acanthocybium solandri       27.0
##  6 Acanthopagrus berda          36  
##  7 Acanthopagrus bifasciatus     6  
##  8 Acanthopagrus latus          35  
##  9 Acanthopagrus schlegeli     NaN  
## 10 Acanthuridae                 16.3
## # ℹ 1,334 more rows
```
